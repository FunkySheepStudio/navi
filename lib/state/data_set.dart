...
class DataSet with ChangeNotifier {
  ...
  /// A broadcaster for parsed NMEA values.
  final NmeaWebsocketServer? _websocketServer;
  ...
  DataSet(this._networkSettings, this._derivedDataSettings, this._historyManager, [this._websocketServer]) {
